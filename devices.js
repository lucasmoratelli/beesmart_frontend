async function getToggle(deviceId) {
    let response = await fetch("http://192.168.23.23:8080/toggle/" + deviceId,);
    //let response = await fetch("http://192.168.174.76:8080/toggle/" + deviceId,);
...
async function getDevices() {
    ...
    let response = await fetch("http://192.168.23.23:8080/actuator/");
    //let response = await fetch("http://192.168.174.76:8080/actuator/");
